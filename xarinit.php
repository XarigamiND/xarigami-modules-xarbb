    ...
    switch ($oldversion) {
       ...
       // Get database information
        ...
        case '1.2.2':
            ...
            // Fall through to next upgrade version
        case '1.3.2':
            xarModSetVar('xarbb','xarbbonline',TRUE);
        case '1.3.1':
        case '1.3.2': //current
...
function xarbb_convertdates()
{
       ...
       for (; !$result->EOF; $result->MoveNext()) {
          ...
          $thisdate = new xarDateTime();
          $thisdate->DBtoTS($ttime);
          $newttime=$thisdate->getTimestampe();
          $anotherdate = new xarDateTime();
          $anotherdate->DBtoTS($tftime);
          $newtftime=$anotherdate->getTimestampe();
